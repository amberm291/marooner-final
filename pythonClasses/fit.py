...
class userFit(userPreprocess,catPreprocess):
	...
	def resizeCat(self):
		...
		cv2.imwrite('debug/resizedCatImg.png',self.catImg)
		#return self.catImg
	...
	def sleeveFit(self):
		...
		cv2.imwrite('debug/leftUserRot.png',leftUserRot)
		cv2.imwrite('debug/rightUserRot.png',rightUserRot)
		cv2.imwrite('debug/leftCatRot.png',leftCatRot)
		cv2.imwrite('debug/rightCatRot.png',rightCatRot)

		leftUserFit = self.leftFit(leftUserRot,leftCatRot)
		rightUserFit = self.rightFit(rightUserRot,rightCatRot)

		cv2.imwrite('debug/leftUserFit.png',leftUserFit)
		cv2.imwrite('debug/rightUserFit.png',rightUserFit	)
